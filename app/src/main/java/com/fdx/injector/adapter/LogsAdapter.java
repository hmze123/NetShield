...
// import com.fdx.injector.coreservice.logger.LogItem;
...
public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.logViewHolder>
        implements LogListener, Handler.Callback, View.OnTouchListener {
    ...
    private static final int MAX_STORED_LOG_ENTRIES = 200;
    ...
    public LogsAdapter(LinearLayoutManager layoutManager, Context context) {
        ...
        int levelLog = MainActivity.sShared.getInt(Settings.LOG_LEVE, 1);
    ...
    public void onBindViewHolder(final logViewHolder viewHolder, final int position) {
        ...
        viewHolder.textLog.setOnClickListener(
        ...
        viewHolder.textLog.setOnLongClickListener(
    ...
    private String getTime(LogItem le, int time) {
        if (time != TIME_FORMAT_NONE) {
            ...
            else if (time == TIME_FORMAT_SHORT) timeformat = new SimpleDateFormat("HH:mm");
            else timeformat = DateFormat.getTimeFormat(mContext);
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.what == MESSAGE_NEWLOG) {
            ...
            if (addLogMessage(logMessage)) {
                ...
                if (!mLockAutoScroll) scrollToLastPosition();
            }
